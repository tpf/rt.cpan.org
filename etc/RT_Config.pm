...
#
#   $ ./configure --prefix=/home/rtcpan/rt --with-db-type=mysql --with-db-host= --with-db-database=rt_cpan_org --disable-gpg --with-web-handler=fastcgi,standalone --with-my-user-group
#
...
Set($DatabaseName, q{rt_cpan_org});
